...
var SettingsModel = function () {
	...
	// Save the values.
	self.sideOfBlade.subscribe(function (value: string) {
		window.localStorage.setItem("sideOfBlade", value);
	});
	self.maxQuantity.subscribe(function (value: string) {
		window.localStorage.setItem("maxQuantity", value);
	});
	self.moneySymbol.subscribe(function (value: string) {
		window.localStorage.setItem("moneySymbol", value);
	});
	self.moneySymbolLocation.subscribe(function (value: string) {
